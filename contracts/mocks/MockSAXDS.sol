...
/**
 * A mock version of sAXDS, with an over-simplified rebase mechanism, for testing purposes only
 */
contract MockSAXDS is ERC20 {
    ...
    constructor(uint256 initialIndex_, uint256 rebasePct_) ERC20("Mock sAXDS", "sAXDS") {
